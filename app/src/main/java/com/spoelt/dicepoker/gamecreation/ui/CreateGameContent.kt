...
import com.spoelt.dicepoker.core.constants.LOGO_WIDTH_PERCENTAGE
import com.spoelt.dicepoker.core.ui.components.GameOptionCard
import com.spoelt.dicepoker.core.ui.components.PrimaryButton
import com.spoelt.dicepoker.core.ui.components.VerticalSpacer
...
private fun GameOptions(
    ...
    GameOptionCard(
        isExpanded = gameOptions.isColumnCardExpanded,
    ...
    GameOptionCard(
        isExpanded = gameOptions.isPlayerCardExpanded,
    ...
    override val values: Sequence<CreateGameViewState>
        get() {
            ...
            return sequenceOf(
                ...
                CreateGameViewState.Active(gameOptions),
                CreateGameViewState.Creating(gameOptions),
